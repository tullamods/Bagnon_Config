...
-- general
L.GeneralDesc = '애드온에 전체에 사용되는 일반적인 설정입니다.'
L.Locked = '프레임 위치 잠금'
L.Fading = '프레임 사라짐 효과 사용'
L.TipCount = '아이템 갯수를 툴팁에 표시'
L.FlashFind = '빠른 찾기 사용'
L.EmptySlots = '빈칸 배경 표시'
L.DisplayBlizzard = '비활성화된 가방을 보기위해 블리자드 프레임을 표시합니다(자동으로 UI를 재시작합니다).'
...
L.ExclusiveReagent = '재료 은행 별도로 표시'

L.BagFrame = '가방 표시'
L.Money = '소지 금액 표시'
L.Broker = '데이터브로커 플러그인 표시'
L.Sort = '정렬 버튼 표시'
L.Search = '검색 버튼 표시'
L.Options = '설정 버튼 표시'
...
L.Appearance = '표시'
L.Layer = '레이어'
L.BagBreak = '개별 가방으로 구분하여 표시'
L.ReverseBags = '가방 역순 정렬'
L.ReverseSlots = '가방 칸 역순 정렬'
...
L.GlowSets = '세트 아이템 강조'
L.ColorSlots = '가방 종류에 따라 빈칸 색 표시'
