...
L.ReverseBags = 'Orden inverso de bolsas'
L.ReverseSlots = 'Orden inverso de ranuras'
...
L.GlowSlots = 'Colorear ranuras vacías por tipo de bolsa'

L.NormalColor = 'Bolsas normales'
L.LeatherColor = 'Bolsas de peletería'
L.InscrbeColor = 'Bolsas de inscripción'
