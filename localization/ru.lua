...
L.NormalColor = 'Обычный цвет ячейки сумки'
L.LeatherColor = 'Цвет ячейки сумки кожевника'
L.InscribeColor = 'Цвет ячейки сумки начертателя'
L.HerbColor = 'Цвет ячейки сумки травника'
L.EnchantColor = 'Цвет ячейки сумки зачарователя'
L.EngineerColor = 'Цвет ячейки сумки инженера'
L.GemColor = 'Цвет ячейки сумки ювелира'
L.MineColor = 'Цвет ячейки сумки шахтера'
L.TackleColor = 'Цвет ячейки рюкзака'
